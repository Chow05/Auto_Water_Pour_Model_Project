...
const float KC_CB_toi_Coc = 50.0;  // Đơn vị cm, giá trị x10 so với thực tế để mô phỏng
const float ChieuCaoCoc = 100.0;   // Đơn vị cm, giá trị x10 so với thực tế để mô phỏng
...
void DoMucNuoc() {
  ...
  MucNuoc = 100.0 * (KhoangCach - KC_CB_toi_Coc) / ChieuCaoCoc;
